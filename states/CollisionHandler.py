...
class CollisionHandler():
    ...
    def check_asteroid_p_bullet_collisions(self):
        ...
        self.game.spriteHandler.bullets, self.game.spriteHandler.asteroids, True, True)
    ...
    def check_enemy_p_bullet_collisions(self):
        ...
        self.game.spriteHandler.bullets, self.game.spriteHandler.enemies, True, True)
    ...
    def check_enemy_bullet_collisions(self):
        enemy_bullet_collisions = pygame.sprite.spritecollide(self.game.spriteHandler.spaceship, self.game.spriteHandler.enemy_bullets, True)
    ...
    def check_player_collisions(self):
        collision_with_enemy = pygame.sprite.spritecollide(
            self.game.spriteHandler.spaceship, self.game.spriteHandler.enemies, True)

        collision_with_asteroid = pygame.sprite.spritecollide(
            self.game.spriteHandler.spaceship, self.game.spriteHandler.asteroids, True)
